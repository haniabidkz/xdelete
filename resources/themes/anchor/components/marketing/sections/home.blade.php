    ...
    <div class="row">
      <div class="col-lg-5">
        <div class="xdelete-v2-thumb thumb-mr">
          <img src="assets/images/v2/x lap.png" alt="">
...
<div class="xdelete-testimonial-slider-section xdelete-section-padding2" style="background-image: url(assets/images/v2/t-bg.png)">
  <div class="container">
...
<div class="section xdelete-section-padding3 bg-light position-relative">
  <div class="container">
    ...
    <div class="row" id="table-price-value" data-pricing-dynamic data-value-active="monthly">
      <div class="col-xl-4 col-md-6">
        <div class="xdelete-pricing-wrap">
          <div class="xdelete-pricing-header">
            <h5>Basic</h5>
          </div>
          <div class="xdelete-pricing-price">
            <h2>$</h2>
            <div class="xdelete-price dynamic-value" data-active="19" data-monthly="19" data-yearly="39"></div>
          ...
          <a class="xdelete-pricing-btn" href="pricing.html">Select the plan</a>
        </div>
      </div>
      <div class="col-xl-4 col-md-6">
        <div class="xdelete-pricing-wrap active">
          <div class="xdelete-pricing-header">
            <h5>Standard</h5>
          </div>
          <div class="xdelete-pricing-price">
            <h2>$</h2>
            <div class="xdelete-price dynamic-value" data-active="49" data-monthly="49" data-yearly="69"></div>
            <p class="dynamic-value" data-active="USD/Billed monthly" data-monthly="USD/Billed monthly" data-yearly="USD/Billed Yearly"></p>
          </div>
          <div class="xdelete-pricing-description">
          ...
          <a class="xdelete-pricing-btn active" href="pricing.html">Select the plan</a>
        </div>
      </div>
      <div class="col-xl-4 col-md-6">
        <div class="xdelete-pricing-wrap">
          ...
          <div class="xdelete-pricing-price">
            <h2>$</h2>
            <div class="xdelete-price dynamic-value" data-active="89" data-monthly="89" data-yearly="99"></div>
            <p class="dynamic-value" data-active="USD/Billed monthly" data-monthly="USD/Billed monthly" data-yearly="USD/Billed Yearly"></p>
          </div>
          <div class="xdelete-pricing-description">
...
<div class="xdelete-cta-section2">
  <div class="container">
    <div class="xdelete-cta-wrap" style="background-image: url(assets/images/v2/cta-bg.png)">
